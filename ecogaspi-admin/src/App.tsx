...
import { Dashboard, Merchants, Products, Statistics, Login, BusinessCategories, AnnoncesValidation } from './pages';
import { env } from './config';

// Composant enfant qui inclut le gestionnaire de déconnexion automatique
